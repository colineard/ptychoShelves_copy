...
if isempty(p.base_package_path)
    error('p.base_package_path has to be specified for the remote reconstruction.')
end
if isempty(p.ptycho_package_path)
    error('p.ptycho_package_path has to be specified for the remote reconstruction.')
end
