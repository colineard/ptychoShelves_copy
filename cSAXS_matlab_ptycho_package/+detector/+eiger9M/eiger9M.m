...
det.mask = fullfile(p.base_package_path, 'detector_masks', 'eiger_1_valid_mask.h5');    % detector mask
...
det.H5_detector_path = '/entry/instrument/eiger_1/'; % path inside the H5/NEXUS file
det.orientation = [];                   % [<Transpose> <FlipLR> <FlipUD>], e.g. [1 0 1];  not needed for cSAXS NxSAS Nexus files; 
