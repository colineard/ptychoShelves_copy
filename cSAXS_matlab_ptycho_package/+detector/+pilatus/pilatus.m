...
det.mask = fullfile(p.base_package_path, 'detector_masks', 'pilatus_1_valid_mask.h5');    % detector mask
...
det.H5_detector_path = '/entry/instrument/pilatus_1/data/'; % path inside the H5/NEXUS file
det.orientation = [];                   % [<Transpose> <FlipLR> <FlipUD>]
